...
namespace 课程表
{
    public static class Autos
    {
        ...
        static int[] ColorArray = { 0x3E7EA8 , 0x0D4C9A ,0x109E4F ,0x354E49 ,0x777672 ,0xB0120F
                ,0x04040C ,0x6B6E7C ,0x1DA15D ,0x7C24CC ,0x4C2C8C ,0x442464
                ,0x142CAC ,0x24ACCC ,0x3337B6 ,0x196DDC ,0xDA0404 ,0xFC246C
                ,0xE62163 ,0xF4A404};
        public static System.Drawing.Color AutoColor(decimal id,string name,bool random)
        {
            var res = new System.Drawing.Color();
            var seed = DateTime.Now.Millisecond.GetHashCode() + DateTime.Now.GetHashCode();
            if (random)
            {
                Random random1 = new Random(name.GetHashCode() + seed);
